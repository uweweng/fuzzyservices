...
public class FuzzyLRIntervalResources {
    ...
    public Response getById(@PathParam("id") int id) {
        ...
        return Response.ok(new FuzzyLRIntervalResource(bean)).build();
    }
     ...
     */
    @POST
    public Response create(FuzzyLRIntervalResource newResource) {
    ...
    public Response put(FuzzyLRIntervalResource resource) {
        FuzzyLRIntervalResource response = new FuzzyLRIntervalResource(dao.update(resource.getBean()));
     ...
     */
    @DELETE
    public void delete(FuzzyLRIntervalResource resource) {
