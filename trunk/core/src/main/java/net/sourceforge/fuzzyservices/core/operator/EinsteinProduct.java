 ...
 * <tt>c = (a*b)/(2-(a+b-a*b))</tt>.
 *
 * @since 1.0
 * @author Uwe Weng
 */
public class EinsteinProduct extends AbstractMultiplyingOperator
    ...
    public String toString() {
        return FuzzyResourceManager.getString(this, "OPERATOR_EINSTEIN_PRODUCT");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj != null) && (obj instanceof EinsteinProduct)) {
            isEqual = true;
        }
        return isEqual;
    }
