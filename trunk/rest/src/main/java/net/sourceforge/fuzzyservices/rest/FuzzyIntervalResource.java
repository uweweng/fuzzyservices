 ...
 */
@XmlRootElement
public class FuzzyIntervalResource {
     ...
     */
    protected FuzzyInterval bean;
    /**
     * The Data Access Object
     */
    @XmlTransient
    protected DaoI<FuzzyInterval, Integer> dao = new FuzzyIntervalDao();

    /**
     * Default constructor
     */
    public FuzzyIntervalResource() {
    }
     ...
     */
    public FuzzyIntervalResource(FuzzyInterval bean) {
        this.bean = bean;
    }
     ...
     */
    public void setBean(FuzzyInterval bean) {
        this.bean = bean;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        FuzzyIntervalResource res = (FuzzyIntervalResource) obj;
