...
/**
 * This class represents myresource beans as resources hosted at the URI path
 * "/myresources". For instance,
 *
 * http://localhost:8080/net/sourceforge/fuzzyservices/myresources/4711 curl -i
 * http://localhost:8080/net/sourceforge/fuzzyservices/myresources/4711 -H
 * ’Accept: text/plain’
 *
 * @see MyResource
 *
...
public class MyResources {
     ...
     */
    private DaoI<MyResourceBean, Integer> dao = new MyResourceDao();
    ...
    public Response getById(@PathParam("id") int id) {
        MyResourceBean bean = dao.findById(id);
        if (bean == null) {
            return Response.status(404).build();
        }
        return Response.ok(new MyResource(bean)).build();
    }
     ...
     */
    @POST
    public Response create(MyResource newResource) {
     ...
     */
    @PUT
    public Response put(MyResource resource) {
        MyResource response = new MyResource(dao.update(resource.getBean()));
     ...
     */
    @DELETE
    public void delete(MyResource resource) {
