...
/**
 * This class defines Data Access Object layer for fact bases.
 *
 * @version 1.0
 * @author Uwe Weng
 */
public class FactBaseDao extends AbstractDaoImpl<FactBase, Integer> {
    ...
    public FactBaseDao() {
        super(FactBase.class);
    }

    public FactBaseDao(EntityManagerFactory emf) {
        super(FactBase.class, emf);
    }
    ...
    public FactBase findByName(final String name) {
        ...
        FactBase data = null;
        try {
            Query query = em.createNamedQuery("findFactBaseByName");
            query.setParameter("name", name);
            data = (FactBase) query.getSingleResult();
        } catch (Exception e) {
