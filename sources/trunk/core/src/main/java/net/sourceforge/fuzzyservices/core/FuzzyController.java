...
public final class FuzzyController
{
     ...
     */
    public static FactBase performApproximateReasoning( RuleBase aRuleBase, FactBase aFactBase,
    ...
    protected static FactBase applyTo( final FactBase fb, final Rule rule, HashMap<String, LinguisticVariable> lv )
    {
        ...
        if ( rule.getCertainty(  ) > 0.0f )
        {
            ...
            totalCompatibilityMeasure = ( 
                                            ( rule.getAggregationOperator(  ).isValidTNorm(  ) == true ) ? 1.0f : 0.0f
                                         );
                ...
                if ( fact != null )
                {
                    ...
                    if ( lingVarAnte != null )
                    {
                        ...
                        totalCompatibilityMeasure = rule.getAggregationOperator(  )
                                                        .compute( totalCompatibilityMeasure, anteCompatibilityMeasure );
                    }
                }
