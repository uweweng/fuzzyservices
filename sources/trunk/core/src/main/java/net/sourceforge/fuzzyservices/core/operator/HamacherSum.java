 ...
 * <tt>c = (a+b-2ab)/(1-a*b)</tt>.
 *
 * @since 1.0
 * @author Uwe Weng
 */
public class HamacherSum extends AbstractComplexOperator
    ...
    public String toString() {
        return FuzzyResourceManager.getString(this, "OPERATOR_HAMACHER_SUM");
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj != null) && (obj instanceof HamacherSum)) {
            isEqual = true;
        }
        return isEqual;
    }
