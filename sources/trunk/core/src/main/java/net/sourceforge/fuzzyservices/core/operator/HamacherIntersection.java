 ...
 * @author Uwe Weng
 */
public class HamacherIntersection extends AbstractMultiplyingParameteredOperator
    ...
    public HamacherIntersection(final float param)
        ...
        if (isValidParameter(param)) {
            ...
            throw new IllegalArgumentException(FuzzyResourceManager.getString(this, "EXCEPTION_OPERATOR_HAMACHER_INTERSECTION_INVALID_PARAMETER"));
        }
    }
    ...
    public String toString(final boolean withParameter) {
        if (withParameter) {
            return FuzzyResourceManager.getString(this, "OPERATOR_HAMACHER_INTERSECTION_WITH_PARAMETER", new Object[]{Float.toString(parameter)});
        } else {
