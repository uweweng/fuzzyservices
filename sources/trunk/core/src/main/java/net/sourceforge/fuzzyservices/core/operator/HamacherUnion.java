...
public class HamacherUnion extends AbstractComplexParameteredOperator
    ...
    public HamacherUnion(final float param) throws IllegalArgumentException {
        if (isValidParameter(param)) {
            ...
            throw new IllegalArgumentException(FuzzyResourceManager.getString(this, "EXCEPTION_OPERATOR_HAMACHER_UNION_INVALID_PARAMETER"));
        }
    }
    ...
    public String toString(final boolean withParameter) {
        if (withParameter) {
            return FuzzyResourceManager.getString(this, "OPERATOR_HAMACHER_UNION_WITH_PARAMETER", new Object[]{Float.toString(parameter)});
        } else {
