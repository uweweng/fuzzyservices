...
public class CoreRuleModel extends AbstractRuleModel {
    ...
    public OperatorModel getCertaintyOperator() {
        return (rule != null)
        ? new CoreOperatorModel(rule.getCertaintyOperator()) : null;
    }

    @Override
    public OperatorModel getInferenceOperator() {
        return (rule != null)
        ? new CoreOperatorModel(rule.getInferenceOperator()) : null;
    }

    @Override
    public OperatorModel getAggregationOperator() {
        return (rule != null)
        ? new CoreOperatorModel(rule.getAggregationOperator()) : null;
    }
    ...
    public OperatorModel getCompatibilityOperatorOfAntecedentAt(int index) {
        return (rule != null)
        ? new CoreOperatorModel(rule.getAntecedentAt(index)
    ...
    public String getLingVarNameOfAntecedentAt(int index) {
        return (rule != null)
        ? rule.getAntecedentAt(index).getLinguisticVariableName() : null;
    }
    ...
    public String getLingTermNameOfAntecedentAt(int index) {
        return (rule != null)
        ? rule.getAntecedentAt(index).getLinguisticTermName() : null;
    }
    ...
    public String getLingVarNameOfConsequentAt(int index) {
        return (rule != null)
        ? rule.getConsequentAt(index).getLinguisticVariableName() : null;
    }
    ...
    public String getLingTermNameOfConsequentAt(int index) {
        return (rule != null)
        ? rule.getConsequentAt(index).getLinguisticTermName() : null;
    }
