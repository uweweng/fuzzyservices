...
public class RuleBaseDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(mydesktopapplication.MyDesktopApplication.class)
                                                                                               .getContext()
                                                                                               .getResourceMap(RuleBaseDialog.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(mydesktopapplication.MyDesktopApplication.class)
                                                                              .getContext()
                                                                              .getActionMap(RuleBaseDialog.class,
                this);
        ...
        nameEditorPanel.setLayout(new java.awt.FlowLayout(
        ...
        ruleListEditorPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(
                resourceMap.getString("ruleListEditorPanel.border.title"))); // NOI18N
    ...
    public static void main(String[] args) {
        java.awt.EventQueue.invokeLater(new Runnable() {
                public final void run() {
                    RuleBaseDialog dialog = new RuleBaseDialog(new javax.swing.JFrame(),
                            true);
