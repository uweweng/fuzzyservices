...
/**
 * This class represents a fact base bean as resource hosted at the URI path 
 * "/id". JAXB is used for serialisation.
 * 
 * http://localhost:8080/net/sourceforge/fuzzyservices/fact_bases
 * curl -i http://localhost:8080/net/sourceforge/fuzzyservices/fact_bases -H ’Accept: text/plain’
 *
 * @version 1.0
 * @author Uwe Weng
 */
@XmlRootElement
public class FactBaseResource {
     ...
     */
    protected FactBase bean;

    /**
     * Default constructor
     */
    public FactBaseResource() {
    }
     ...
     */
    public FactBaseResource(FactBase bean) {
        this.bean = bean;
    }
     ...
     */
    public void setBean(FactBase bean) {
        this.bean = bean;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        FactBaseResource res = (FactBaseResource) obj;
