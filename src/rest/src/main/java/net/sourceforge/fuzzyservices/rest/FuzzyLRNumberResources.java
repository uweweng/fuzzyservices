...
public class FuzzyLRNumberResources {
    ...
    public Response getById(@PathParam("id") int id) {
        ...
        return Response.ok(new FuzzyLRNumberResource(bean)).build();
    }
     ...
     */
    @POST
    public Response create(FuzzyLRNumberResource newResource) {
    ...
    public Response put(FuzzyLRNumberResource resource) {
        FuzzyLRNumberResource response = new FuzzyLRNumberResource(dao.update(resource.getBean()));
     ...
     */
    @DELETE
    public void delete(FuzzyLRNumberResource resource) {
