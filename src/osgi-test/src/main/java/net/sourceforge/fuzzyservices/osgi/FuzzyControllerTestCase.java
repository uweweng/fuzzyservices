...
/**
 * Test of OSGi service FuzzyController using 
 ...
 * @author Uwe Weng
 */
public class FuzzyControllerTestCase extends OSGiTestCase {

    /**
     * Test the availability of the service FuzzyController.
     */
    public void testGetService() {
        ...
        ServiceReference reference = getServiceReference(FuzzyController.class.getName());
        assertNotNull("Assert Service Reference", reference);
        FuzzyController service = (FuzzyController) getContext().getService(reference);
        assertNotNull("Assert Service Availability", service);
    }

    /**
     * Test of performApproximateReasoning method, of service FuzzyController.
     */
    public final void testPerformApproximateReasoning() {
        ...
        FuzzyController service = (FuzzyController) getContext().getService(reference);
        assertNotNull("Assert Service Availability", service);
        service.performApproximateReasoning(new RuleBase(), new FactBase(), null);
    }
}
