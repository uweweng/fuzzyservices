 ...
 * 
 * http://localhost:8080/net/sourceforge/fuzzyservices/fuzzynumbers
 * curl -i http://localhost:8080/net/sourceforge/fuzzyservices/fuzzynumbers -H ’Accept: text/plain’
 *
 * @version 1.0
 * @author Uwe Weng
 */
...
public class FuzzyNumberResource {
     ...
     */
    @XmlTransient
    protected DaoI<FuzzyNumber, Integer> dao = new FuzzyNumberDao();
