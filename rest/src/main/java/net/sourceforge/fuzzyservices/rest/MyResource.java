...
/**
 * This class represents a myresource bean as resource hosted at the URI path 
 * "/id". JAXB is used for serialisation.
 * 
 * http://localhost:8080/net/sourceforge/fuzzyservices/myresources
 * curl -i http://localhost:8080/net/sourceforge/fuzzyservices/myresources -H ’Accept: text/plain’
 *
 * @version 1.0
 * @author Uwe Weng
 */
...
public class MyResource {
     ...
     */
    public MyResource(MyResourceBean bean) {
        this.bean = bean;
    }
     ...
     */
    public void setBean(MyResourceBean bean) {
        this.bean = bean;
    }
