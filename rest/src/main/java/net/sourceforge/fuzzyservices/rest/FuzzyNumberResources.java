...
public class FuzzyNumberResources {
    ...
    public Response getById(@PathParam("id") int id) {
        ...
        return Response.ok(new FuzzyNumberResource(bean)).build();
    }
     ...
     */
    @POST
    public Response create(FuzzyNumberResource newResource) {
     ...
     */
    @PUT
    public Response put(FuzzyNumberResource resource) {
        FuzzyNumberResource response = new FuzzyNumberResource(dao.update(resource.getBean()));
     ...
     */
    @DELETE
    public void delete(FuzzyNumberResource resource) {
