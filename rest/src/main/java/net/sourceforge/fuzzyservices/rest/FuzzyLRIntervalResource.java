 ...
 * 
 * http://localhost:8080/net/sourceforge/fuzzyservices/fuzzy_lr_intervals
 * curl -i http://localhost:8080/net/sourceforge/fuzzyservices/fuzzy_lr_intervals -H ’Accept: text/plain’
 *
 * @version 1.0
 * @author Uwe Weng
 */
@XmlRootElement
public class FuzzyLRIntervalResource {
     ...
     */
    protected FuzzyLRInterval bean;
    /**
     * The Data Access Object
     */
    @XmlTransient
    protected DaoI<FuzzyLRInterval, Integer> dao = new FuzzyLRIntervalDao();

    /**
     * Default constructor
     */
    public FuzzyLRIntervalResource() {
    }
     ...
     */
    public FuzzyLRIntervalResource(FuzzyLRInterval bean) {
        this.bean = bean;
    }
     ...
     */
    public FuzzyLRInterval getBean() {
        return bean;
    }
     ...
     */
    public void setBean(FuzzyLRInterval bean) {
        this.bean = bean;
    }
     ...
     */
    @PUT
    public Response put(FuzzyLRIntervalResource resource) {
        try {
    ...
    public final boolean equals(Object obj) {
        ...
        FuzzyLRIntervalResource res = (FuzzyLRIntervalResource) obj;
